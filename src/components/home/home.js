            ...
            <div>
                ...
                <div id="home-main">
                    <div className="home-main-block">
                        <div className="home-main-block-content">
                            <p className="home-main-center-paragraph">
                    ...
                    <div className="home-main-block">
                        <div className="home-main-block-header">
                            OUR SOLUTION
                        </div>
                        <div className="home-main-block-content">
                            <p className="home-main-center-paragraph">
                    ...
                    <div className="home-main-block">
                        ...
                        <div className="home-main-block-content">
                            <p style={{marginBottom: "3 em"}} className="home-main-center-paragraph">
                    ...
                    <div className="home-main-block">
                        ...
                        <div className="home-main-block-content">
                            ...
                            <ol className="home-main-block-content-list">
                                <li className="home-main-block-content-list-item">
                    ...
                    <div className="home-main-block">
                        ...
                        <div className="home-main-block-content">
                            ...
                            <NavLink to="/products" className="button-a">
                                <div className="button home-main-block-single-button">
                                    Products                                                
                                </div>
                            </NavLink>
                        </div>                        
